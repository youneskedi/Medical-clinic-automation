...
{
    public partial class Formspla : Form
    {
        ...
        {
            InitializeComponent();
            da = new SqlDataAdapter("select * from Specialization", con);
            da.Fill(dt);
        ...
        private void butAnaADD_Click(object sender, EventArgs e)
        {
            try
            {
                string m = "UPDATE Specialization SET spName= '" + textBox1ANA.Text + "' where spID =" + txid.Text + "";
        ...
        private void butDeleted_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql1 = "Delete From Specialization where spID ='" + txid.Text + "'";
        ...
        private void Formspla_Load(object sender, EventArgs e)
        {
            txid.Visible = false;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "insert into Specialization values(@spName)";
                cmd3 = new SqlCommand(sql, con);
                cmd3.Parameters.AddWithValue("spName", textBox1ANA.Text);
